 ...
 * All rights reserved
 *************************************************************************************************
 * $Id: //software/teams/phy/pl1_dev.br/modem/l123/phy/test/pl1_testbench_framework/jenkins_interface/common/swtools/drivers/public/drv_arch_type.h#1 $
 * $Revision: #1 $
 * $Date: 2014/11/13 $
 * $Author: joashr $
 ************************************************************************************************/
...
#if defined (ICE9XXX_UMCO)
#define DRV_ARCH_CHUNK          (128*1024)
#elif defined (ICE9XXX_BBMCI)
...
#define ARCH_PROP_IMEI_EXT_AUTH       {ARCH_ACR_IMEI,        ARCH_ID_IMEI,        ARCH_EXT_AUTH,          ARCH_NO_PPID, false, ARCH_TYPE_DATA,  true,  false, false}
#define ARCH_PROP_IMEI_SOFT_ACTIVATION  {ARCH_ACR_IMEI,     ARCH_ID_IMEI,    ARCH_ACT_ACT_KEY_SET,  ARCH_PPID,  false, ARCH_TYPE_DATA,true, false, false}
#define ARCH_PROP_IMEI_ENCRYPTED_IMEI_FILE {ARCH_ACR_IMEI,  ARCH_ID_IMEI,        ARCH_SELF_ENCRYPTION,           ARCH_NO_PPID, false, ARCH_TYPE_DATA,  false,  false, false}
#define ARCH_PROP_IMEI         {ARCH_ACR_IMEI,     ARCH_ID_IMEI,    ARCH_OEM_FACT_KEY_SET, ARCH_PPID,  false, ARCH_TYPE_DATA,true, false, false}

#define ARCH_PROP_CUSTCFG_NO_AUTH     {ARCH_ACR_CUSTCFG,     ARCH_ID_CUSTCFG,     ARCH_NO_AUTH,           ARCH_NO_PPID, false, ARCH_TYPE_DATA,  true,  false, false}
#define ARCH_PROP_CUSTCFG_EXT_AUTH    {ARCH_ACR_CUSTCFG,     ARCH_ID_CUSTCFG,     ARCH_EXT_AUTH,          ARCH_NO_PPID, false, ARCH_TYPE_DATA,  true,  false, false}
...
#define ARCH_PROP_ZEROCD_IGNORE_MAGIC {ARCH_ACR_ZEROCD,      ARCH_ID_ZEROCD,      ARCH_NO_AUTH,           ARCH_NO_PPID, true,  ARCH_TYPE_DATA,  true,  false, true}
...
#define ARCH_PROP_CALIB_EXT_AUTH      {ARCH_ACR_CALIB,       ARCH_ID_CALIB,       ARCH_EXT_AUTH,          ARCH_NO_PPID, false, ARCH_TYPE_DATA,  false, false, false}
...
#define ARCH_PROP_DEVICECFG_NO_AUTH   {ARCH_ACR_DEVICECFG,   ARCH_ID_DEVICECFG,   ARCH_NO_AUTH,           ARCH_NO_PPID, false, ARCH_TYPE_DATA,  true,  false, false}
#define ARCH_PROP_DEVICECFG_EXT_AUTH  {ARCH_ACR_DEVICECFG,   ARCH_ID_DEVICECFG,   ARCH_EXT_AUTH,          ARCH_NO_PPID, false, ARCH_TYPE_DATA,  true,  false, false}
#define ARCH_PROP_DEVICECFG_NO_PPID   {ARCH_ACR_DEVICECFG, ARCH_ID_DEVICECFG, ARCH_OEM_FACT_KEY_SET, ARCH_NO_PPID, false, ARCH_TYPE_DATA, true, false, false}
